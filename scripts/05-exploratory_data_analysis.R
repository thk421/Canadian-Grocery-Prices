...
avg_price_stacked_bar <-
  ...
  labs(
    title = "Weekly Meal Plan Cost by Vendor and Food Category",
    x = "Vendor",
    y = "Weighted Cost ($)",
    fill = "Food Category",
    caption = "Source: Your Data"
...
avg_stock_facet <-
  ...
  labs(
    title = "Count of Products in Stock by Vendor and Food Category",
    x = "Vendor",
